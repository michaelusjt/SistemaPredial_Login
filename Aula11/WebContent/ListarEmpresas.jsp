                        ...
                        <table class="table table-striped" cellspacing="0" cellpadding="0">
                            <thead>
                                <tr>
                                    ...
                                    <th>RazaoSocial</th>
                                    <th>Conjunto</th>
                                    <th>HorarioDeFuncionamento</th>
                                    <th>TemperaturaDoArCondicionado</th>
                                    <th>HorarioDoArCondicionado</th>
          					...
          					<c:forEach var="empresa" items="${lista }">
                                       <tr>
                                            ...
                                            <td>
                                             ...
                                             <td>
                                                ${empresa.temperaturaDoArCondicionado }
                                            </td>
                                                <td>
                                                ${empresa.horarioDoArCondicionado }
                                            </td>
                                            <td class="actions">
                                                <a class="btn btn-success btn-xs" href="controller.do?command=VisualizarEmpresa&id=${empresa.id }">Visualizar</a>
                                                <a class="btn btn-warning btn-xs" href="controller.do?command=EditarEmpresa&id=${empresa.id }">Editar</a>
                                                <button id="btn${empresa.id }%>" type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete-modal" data-cliente="${empresa.id }">Excluir</button>
                                            </td>
                                        </tr>             
                            </c:forEach>
